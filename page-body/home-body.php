<main>
    <div class="page-wrapper">
        ...
        <div id="controls-carousel banner-image" class="relative" data-carousel="static">
            <!-- Carousel wrapper -->
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-8 mx-auto">
                <div class="flex flex-col">
                    <!-- <div class="h-1 bg-yellow-200 rounded overflow-hidden">
                    ...
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <p class="leading-relaxed mb- text-justify">“Any great leader today should have the ability to maintain a productive and healthy work environment to increase employment opportunities to proliferate sustainability.”</p>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <p class="leading-relaxed mb-3 text-justify">“The intensity of employee centrism should be implemented with equitable care, reward, and recognition.”
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <p class="leading-relaxed mb-3 text-justify">
                                    “It is important for every organization to understand the impact of the digital economy in the transformation of businesses.”
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
                                    Chairman & CEO, DevoTech
                                </h2>
                                <p class="leading-relaxed mb-3 text-justify leading-none">
                                    “Appreciation of work can enhance the engagement of the employees and employee engagement supports an organization as an investment that creates the privilege of staying in business.”
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <p class="leading-relaxed mb-3 text-justify">"Transparency and honesty are only effective when employees have the will of resurgence to back it up. Together, they can make the changes drastically."
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Former President,
                                    DCCI, Managing Director, Shasha Denims Ltd.
                                </h2>
                                <p class="leading-relaxed mb-3 text-justify">
                                    “Sustainable and resilient infrastructure development can be facilitated by making a proprietorship among the employees to enhance collaboration and the value chain.”
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Chairman,
                                    Unilever Consumer Care Ltd.
                                </h2>
                                <p class="leading-relaxed mb-3 text-justify">
                                    “The route to a sustainable future is to treat people of the organization as an investment and organization should have the right mix of people in terms of skills and diversity.”
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <p class="leading-relaxed mb-3 text-justify">"To build inclusive and cooperative societal engagements, organizations should improve their CSR policies to complement its transformative landscape and make a better future."
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Managing
                                    Director, BAT Bangladesh
                                </h2>
                                <p class="leading-relaxed mb-3 text-justify">"A significant requirement to achieve success is that employees understand how they contribute to the strategies and focus on the learning opportunities.”
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <p class="leading-relaxed mb-3 text-justify">
                                    "In times of transformation, organizations should adopt innovation to create more opportunities for the entrepreneurs to establish competitive positions as incumbents."
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
                                    Vice-Chancellor, ULAB School of Business</h2>
                                <p class="leading-relaxed mb-3 text-justify">
                                    “In these trying times, radical rethinking is one of the most powerful mechanisms to promote good governance through compliance.”
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Executive
                                    Director, Valor of Bangladesh
                                </h2>
                                <p class="leading-relaxed mb-3 text-justify">
                                    "Using the inner power of a human being can create a better future by diminishing inequality amongst the general population.”
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <p class="leading-relaxed mb-3 text-justify">"Proper transparency and accountability in decision-making is the way of enhancing good governance in an organization.”
                                </p>
                            </div>
                        </div>
                    </div>
